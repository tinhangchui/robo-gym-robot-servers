# Forked robo-gym-robot-servers

This is a forked repository from the original [robo-gym-robot-servers](https://github.com/jr-robotics/robo-gym-robot-servers). I added a robot model for our lab.
